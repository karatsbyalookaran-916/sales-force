...
import {
  ...
  validateAccount, validateLead, isUuid, isSessionToken, SESSION_MS
} from './core.mjs';
...
export async function handle(ctx, { store, limiter, setupAvailable }) {
  const { method, path, query = {}, body = {}, token = '', clientId = '' } = ctx;
