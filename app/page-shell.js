(() => {
  ...
  lane.innerHTML = `<div class="karats-page-brand"><button class="karats-page-brand-mark karats-page-toggle" type="button" aria-controls="karatsPageLane" aria-expanded="true" aria-label="Collapse navigation">K</button><a class="karats-page-brand-copy" href="/" aria-label="KARATS home">KARATS<small>TEAM WORKSPACE</small></a></div><nav class="karats-page-nav"><div class="karats-page-nav-label">LEAD MANAGEMENT</div><a href="/#dashboard"><span class="karats-page-icon">◈</span><span class="karats-page-nav-text">Lead dashboard</span></a><a href="/#directory"><span class="karats-page-icon">☷</span><span class="karats-page-nav-text">Lead directory</span></a><a href="/#pipeline"><span class="karats-page-icon">▣</span><span class="karats-page-nav-text">Lead pipeline</span></a><a href="/#scoreboard"><span class="karats-page-icon">★</span><span class="karats-page-nav-text">Scoreboard</span></a><div class="karats-page-nav-label">PRESENTATION TOOLS</div><a href="/Karats-Elite-Plan-Brochure-source.html#presentation" class="${isPresentation ? 'active' : ''}"><span class="karats-page-icon">◇</span><span class="karats-page-nav-text">Presentation</span></a><a href="/Karats-Smart-Capital-Calculator.html" class="${isCalculator ? 'active' : ''}"><span class="karats-page-icon">▦</span><span class="karats-page-nav-text">Capital calculator</span></a><div class="karats-page-nav-label karats-admin-label" hidden>ADMINISTRATION</div><a href="/#team" class="karats-manage-team" hidden><span class="karats-page-icon">♧</span><span class="karats-page-nav-text">Employee management</span></a></nav>`;
  ...
  const showTeamFor = user => { const hidden=user?.role !== 'admin'; teamLink.hidden=hidden; lane.querySelector('.karats-admin-label').hidden=hidden; };
